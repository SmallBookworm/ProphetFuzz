...
# echo "[*] All processes completed successfully." change -f to bind cpu core for different container
# bash $fuzzing_handler_dir/run_fuzzing.sh -p $program -d 1 -c 1 -r 1 -f 0
