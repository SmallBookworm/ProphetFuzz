...
python $llm_interface_dir/restruct_manpage.py --file $manpage_parser_dir/output/manpage_${program}.json

echo "[*] Extracting constraints ..."
python $llm_interface_dir/constraint.py --file $llm_interface_dir/input/manpage_${program}.json

echo "[*] Predicting High-Risk Option Combinations ..."
echo $llm_interface_dir
python $llm_interface_dir/predict.py --file $llm_interface_dir/input/manpage_${program}.json

echo "[*] Assembling the commands ..."
python $llm_interface_dir/assemble.py --file $llm_interface_dir/input/manpage_${program}.json
